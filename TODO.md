...
- "← Back" button reuses the same bold orange as the primary "Can I bunk?" CTA, diluting how much the real CTA stands out. Give Back a neutral/outline treatment instead. (`src/app/SectionSelector.tsx`)
