            ...
            <form onSubmit={(event) => { event.preventDefault(); calculate(); }}>
              <div className="mb-[clamp(17px,2vw,22px)] grid gap-[clamp(16px,1.8vw,20px)]">
                <label className="grid gap-[clamp(7px,.8vw,10px)] text-[12px] leading-[1.1] font-black text-black">
                  Current attendance %
                  {/* The % is positioned against this wrapper, not the label:
                      the label also holds the caption below, so anchoring to it
                      dropped the symbol onto the input's bottom border. */}
                ...
                <label className="grid gap-[clamp(7px,.8vw,10px)] text-[12px] leading-[1.1] font-black text-black">
                  Target attendance %
                  {/* Same wrapper as the field above, so both symbols sit
                      against the input and stay put if a caption is added. */}
                  <div className="relative">
