...
Run migrations `001` through `016` in order in the Supabase SQL Editor. Then create an administrator in **Authentication > Users** and grant access:
...
3. Run all 16 migrations in the production Supabase project.
